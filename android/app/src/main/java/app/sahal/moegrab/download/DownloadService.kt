package app.sahal.moegrab.download
...
import app.sahal.moegrab.bridge.BridgeProgressListener
...
import app.sahal.moegrab.merge.FfmpegMerger
import app.sahal.moegrab.ui.MainActivity
import app.sahal.moegrab.util.SafCopy
...
class DownloadService : Service() {
    ...
    companion object {
        ...
        const val ACTION_CANCEL_CURRENT = "app.sahal.moegrab.action.CANCEL_CURRENT"
